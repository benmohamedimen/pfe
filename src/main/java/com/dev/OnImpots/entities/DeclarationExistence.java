...
public DeclarationExistence(String regimeImpots, String codeTva, String assujettissementTva, String faitGenerateurTva,
		String periodiciteActivite, String periodiciteDeclarationImpots, String assujettissementImpots) {
	super();
	RegimeImpots = regimeImpots;
	CodeTva = codeTva;
	AssujettissementTva = assujettissementTva;
